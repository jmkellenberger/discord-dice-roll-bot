defmodule Witchspace.Campaigns do
  @moduledoc """
  ...
  @doc """
  Converts a campaign's date field to Day/Year format.
  ## Examples
      iex> attrs = %{day: 349, year: 1103, year_length: 365, name: "test"}
      iex> {:ok, campaign} = Witchspace.Campaigns.create_campaign(attrs)
      iex> Witchspace.Campaigns.get_date(campaign)
      %{day: 349, year: 1103}

  """
  def get_date(%Campaign{date: days, year_length: year_length}) do
    %{day: current_day(days, year_length), year: div(days, year_length)}
  end

  def date_to_days(day, year, year_length), do: year * year_length + day

  def current_day(days, year_length) do
    case rem(days, year_length) do
      0 -> year_length
      day -> day
    end
  end

  def current_year(days, year_length), do: div(days, year_length) + 1
end
